...
│   └── Agent_system_prompt.txt # System prompt for the master AI agent
│   └── description_ephemeride_rayonnement # Description field for the ephemeride_rayonnement tool (date mapping handled dynamically)
├── screenshots/        # Illustrative screenshots
│   ├── Log.png         # Example of Google Sheets logging (agentic chain of thoughts CoT)
│   ├── data_mail.png        # Example of email generated by the messaging agent
